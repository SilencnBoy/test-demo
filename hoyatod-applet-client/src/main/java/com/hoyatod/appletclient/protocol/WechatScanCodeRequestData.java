...
public class WechatScanCodeRequestData implements Serializable {

	private static final long serialVersionUID = 1L;

	private String appid; // 公众账号  是 String(32) wxd678efh567hg6787 微信分配的小程序ID
	...
	public String toString() {
		return "WechatAppletData [appid=" + appid + ", mch_id=" + mch_id + ", device_info=" + device_info
